...
export interface ApiInputAspirasiInputAspirasi
  extends Struct.CollectionTypeSchema {
  collectionName: 'input_aspirasis';
  info: {
    displayName: 'Input Aspirasi';
    pluralName: 'input-aspirasis';
    singularName: 'input-aspirasi';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    ket: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::input-aspirasi.input-aspirasi'
    > &
      Schema.Attribute.Private;
    ...
    status_aspirasi: Schema.Attribute.Enumeration<
...
export interface ApiKategoriKategori extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    input_aspirasis: Schema.Attribute.Relation<
      'oneToMany',
      'api::input-aspirasi.input-aspirasi'
    >;
    ket_kategori: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    siswa: Schema.Attribute.Relation<'oneToOne', 'api::siswa.siswa'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::input-aspirasi.input-aspirasi': ApiInputAspirasiInputAspirasi;
